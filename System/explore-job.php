...
<body class="not-transparent-header">
	<div class="container-wrapper">
                             ...
                             <div class="box-white box-detail-job">
                                <div class="box-header">
                                    <a href="company.php?ref=<?php echo "$compid"; ?>" title="Công Ty TNHH Thiết Bị Dân Dụng Thuận Phong" class="company-logo">
                                        ...
                                        <i class="fa-regular fa-clock"></i> Hạn nộp hồ sơ: <?php echo "$post_month"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?>
                                        </div>
                                        </div>
                                        <div class="box-apply-current">
                                        <?php if ($user_online == true) {
                                            if ($jobexpired == true) {
                                                print '<button class="btn btn-topcv-primary btn-primary-hover btn-apply open-apply-modal"><i class="flaticon-line-icon-set-calendar"></i> Hết hạn nộp hồ sơ </button>';
                                            } else {
                                                if ($myrole == 'employee') {
     ...
     '" class="btn btn-primary btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-pencil"></i> Ứng tuyển ngay</button>';
                                                    ...
                                                    print '<button class="btn btn-topcv-primary btn-primary-hover btn-apply open-apply-modal"><i class="flaticon-line-icon-set-padlock"></i> Đăng nhập để ứng tuyển ngay</button>';
                                                }
                                            }
                                        } else {
                                            print '<button class="btn btn-topcv-primary btn-primary-hover btn-apply open-apply-modal"><i class="flaticon-line-icon-set-padlock"></i> Đăng nhập để ứng tuyển ngay</button>';
...
<p class="dateline">Hạn nộp hồ sơ: <?php echo "$post_month"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?></p>
</div>
</div>
</div>
</div>
	...
	<div class="tab-style-01 box-white">
									...
									<ul  role="tablist">
										<li role="presentation" class="active" ><h4 class="box-title">Các công việc khác đến từ <?php echo "$compname"; ?></h4></li>
									</ul>
