...
<head>
	...
	<title>Nightingale Jobs - Ứng viên</title>
...
<body class="not-transparent-header">
	<div class="container-wrapper">
       ...
       try {
           ...
           $stmt = $conn->prepare(
               "SELECT * FROM tbl_users WHERE role = 'employee' ORDER BY first_name LIMIT $page1,16"
           );
           $stmt->execute();
       ...
       try {
           ...
           $stmt = $conn->prepare(
               "SELECT * FROM tbl_users WHERE role = 'employee' ORDER BY first_name"
           );
           $stmt->execute();
           $result = $stmt->fetchAll();
