	...
	<header id="header">
		...
		<div class="main-wrapper">
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Trình độ ngoại ngữ</span></li>
					</ol>
         ...
         try {
             ...
             $stmt = $conn->prepare(
                 "SELECT * FROM tbl_language WHERE member_no = '$myid' ORDER BY id LIMIT $page1,5"
             );
             $stmt->execute();
                       ...
                       '"/></center>';
															...
															<div class="row">
																<div class="col-sm-12 col-md-12">
																	<i class="fa fa-user mr-5"></i> Kỹ năng nói <strong class="mr-10"><?php echo $row[
                     'speak'
                 ]; ?></strong> <i class="fa fa-book mr-5"></i> Kỹ năng đọc<strong class="mr-10"><?php echo $row[
    'reading'
]; ?></strong> <i class="fa fa-pencil mr-5"></i>Kỹ năng viết <strong class="mr-10"><?php echo $row[
    'writing'
]; ?></strong>
																</div>
                  ...
                  'id'
														...
														<a href="app/drop-language.php?id=<?php echo $row[
                  'id'
              ]; ?>" onclick = "return confirm('Are you sure you want to delete this language ?')" class="btn btn-primary btn-sm btn-inverse">Xóa</a>
                  ...
                  'id'
					                                    ...
					                                    <h4 class="modal-title text-center">Sửa <?php echo $row[
                                             'language'
                                         ]; ?></h4>
				                                        </div>
								                        ...
								                        <input class="form-control" value="<?php echo $row[
                                    'language'
                                ]; ?>" placeholder="Enter language name" type="text" name="language" required> 
							                            </div>
                                 ...
                                 print ' selected ';
				                                       ...
				                                       <input type="hidden" name="langid" value="<?php echo $row[
                                               'id'
                                           ]; ?>">
        ...
        try {
            ...
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare(
                "SELECT * FROM tbl_language WHERE member_no = '$myid' ORDER BY id"
            );
            $stmt->execute();
            $result = $stmt->fetchAll();
...
} ?>  href="language.php?page=<?php echo "$b"; ?>"><?php echo $b .
    ' '; ?></a></li><?php }
            print '<li class="paging-nav"';
            if ($page == $records) {
                print 'class="disabled"';
