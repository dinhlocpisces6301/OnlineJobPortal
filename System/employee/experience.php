	...
	<header id="header">
		...
		<div class="main-wrapper">
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Kinh nghiệm làm việc</span></li>
					</ol>
         ...
         try {
             ...
             $stmt = $conn->prepare(
                 "SELECT * FROM tbl_experience WHERE member_no = '$myid' ORDER BY id LIMIT $page1,5"
             );
             $stmt->execute();
             ...
             foreach ($result as $row) {
                 ...
                 ?>
                       ...
                       '"/></center>';
															...
															<div class="row">
																<div class="col-sm-12 col-md-7">
																	<i class="fa fa-building text-primary mr-5"></i><strong class="mr-10"><?php echo $row[
                     'institution'
                 ]; ?></strong>
																</div>
                  ...
                  'id'
									...
									<a href="app/drop-experience.php?id=<?php echo $row[
             'id'
         ]; ?>" onclick = "return confirm('Are you sure you want to delete this experience ?')" class="btn btn-primary btn-sm btn-inverse">Xóa</a>
             ...
             'id'
									...
									<b style="color:#990000">Tất cả các phần có dấu * là bắt buộc</b>
							        ...
							        <div class="form-group"> 
								    <label>Điện thoại của người quản lí</label>
        ...
        try {
            ...
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare(
                "SELECT * FROM tbl_experience WHERE member_no = '$myid' ORDER BY id"
            );
            $stmt->execute();
            $result = $stmt->fetchAll();
...
} ?> href="experience.php?page=<?php echo "$b"; ?>"><?php echo $b .
    ' '; ?></a></li><?php }
            print '<li class="paging-nav"';
            if ($page == $records) {
                print 'class="disabled"';
