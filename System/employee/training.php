								...
								<div class="admin-content-wrapper">
									 		...
									 		?>
														...
														<div class="col-sm-12 col-md-10">
															<div class="content">
																<a 
																	<?php if ($certificate == "") {
																			...
																			?> target="_blank" href="view-certificate-b.php?id=<?= $row['id']; ?> 
																		<?php } ?> 
																">
																<div class="image">
																<?php 
										                    		if ($myavatar == null) {
										                    			...
										                    			print '<center><img alt="image" title="'.$myfname.'" width="100" height="100" src="data:image/jpeg;base64,'.base64_encode($myavatar).'"/></center>';	
										                    		}
										                      	?>
															</div>
															...
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	<i class="fa fa-building text-primary mr-5"></i><strong class="mr-10"><?= $row['institution']; ?></strong>.
																</div>

																<div class="col-sm-12 col-md-3 mt-10-sm">
																	<i class="fa fa-calendar  text-primary mr-5"></i> <?= $row['timeframe']; ?>
																</div>
															</div>
														</a>
													</div>
												...
												<div class="col-sm-12 col-md-2">
													<div class="resume-list-btn">
														<a data-toggle="modal" href="#edit<?= $row['id']; ?>" class="btn btn-primary btn-sm mb-5 mb-0-sm">Edit</a>
														<a href="app/drop-training.php?id=<?= $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this training ?')" class="btn btn-primary btn-sm btn-inverse">Delete</a>
														<div id="edit<?= $row['id']; ?>" class="modal fade login-box-wrapper" tabindex="-1" data-width="550" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				                   						...
				                   						<div class="modal-body">
															<form action="app/update-training.php" method="POST" autocomplete="off" enctype="multipart/form-data">
					                							<div class="row gap-20">
																	<div class="col-sm-12 col-md-12">
							        									<div class="form-group"> 
								    										...
								    										<input class="form-control" value="<?= "$training"; ?>" placeholder="Enter training name" type="text" name="training" required> 
							        									</div>
						             								</div>
																	...
																	<div class="col-sm-12 col-md-12">
																		<div class="form-group"> 
																			...
																			<input class="form-control" value="<?= "$institution"; ?>" placeholder="Enter institution name" type="text" name="institution" required> 
																		</div>
																	</div>
																	...
																	<div class="col-sm-12 col-md-12">
																		<div class="form-group"> 
																			...
																			<input class="form-control" value="<?= "$timeframe"; ?>" placeholder="Eg: 2015 To 2016" type="text" name="timeframe" required> 
																		</div>
																	</div>
																...
																<input type="hidden" name="trainingid" value="<?= $row['id']; ?>">
									...
									<div class="pager-wrapper">
										...
										<?php
											...
											for ($b=1;$b<=$records;$b++)
											{ ?>
												<li class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="training.php?page=<?= "$b"; ?>"><?= $b." "; ?></a></li><?php
											}	
